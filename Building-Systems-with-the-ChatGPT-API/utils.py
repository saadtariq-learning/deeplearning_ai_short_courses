...
def find_category_and_product_only(user_input,products_and_category):
    ...
    system_message = f"""
        You will be provided with customer service queries. 
        The customer service query will be delimited with {delimiter} characters. 
        Output the response strictly as a valid JSON list of objects, where each object has the following format:
        ...
        - OR
        - 'products': a list of products found in the customer service query.
        ...
        The output must ONLY be a valid JSON list with double quotes around all keys and values. 
        The response must not contain any Python-specific syntax like single quotes, backticks, or extra information. 
        Ensure that only the list of objects is returned in the output. 
        """
    messages =  [  
    {'role':'system', 'content': system_message},    
    {'role':'user', 'content': f"{delimiter}{user_input}{delimiter}"},  
